...
namespace CodeWalker
{
    public partial class WorldForm : Form, DXForm
    {
        ...
        private void Init()
        {
            ...
            if (startupviewmode < 0 || startupviewmode >= ViewModeComboBox.Items.Count) startupviewmode = 0;
            ...
            // If icon PNGs are missing next to the exe (see CodeWalker.csproj copy to output), AddIcon adds nothing — avoid indexing past list end.
            MarkerIcon = Icons.Count > 1 ? Icons[1] : (Icons.Count > 0 ? Icons[0] : null);
            LocatorIcon = Icons.Count > 2 ? Icons[2] : MarkerIcon;
